...
| **Time (PST)**    | **Activity**                                       |
|-------------------|----------------------------------------------------|
| 10:00am - 10:50am | *Lecture 1: [Working on a remote server Server](day2-remote_server.html){target="_blank"} & [Introduction to the Command Line Interface](day2-cli_intro.html){target="_blank"} (50 min)* |
